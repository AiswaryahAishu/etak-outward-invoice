        ...
        <GroupItem colCount={3}>
          <GroupItem>
            <SimpleItem
              ...
              editorOptions={{ 
                items: ["Quality Admin Con.", "Tech Solutions", "XYZ Pvt Ltd", "Global Services"],
                value: "Quality Admin Con."
              }} 
            />
            <SimpleItem
              dataField="position"
              ...
              editorType="dxSelectBox"
              editorOptions={{ 
                items: ["Receivable", "Payable", "Online Transfer", "Cash", "Credit Card"],
                value: "Receivable"
              }} 
            />
          ...
          <GroupItem>
            ...
            <SimpleItem
              ...
              editorType="dxSelectBox"
              editorOptions={{ 
                items: ["CUS0034 - Quality Admin", "ACC1001 - John Doe", "ACC2002 - Alpha Corp"],
                value: "CUS0034 - Quality Admin"
              }} 
            />
          ...
          <GroupItem>
            ...
            <SimpleItem
              ...
              editorType="dxSelectBox"
              editorOptions={{ 
                items: ["Zero Tax", "GST 5%", "GST 12%", "VAT 10%", "Exempted"],
                value: "Zero Tax"
              }} 
            />
